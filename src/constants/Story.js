...
export let AREATHREE = {
         ...
         three:
           "A large staircase expands into blackness. As you make your way to the base of stairs, weaving in-an-out of these unspeakable statues twisted in hilarity and torment, a terrible shuffling noise is heard over head. Looking up, a human figure is seen flipping through the rafters in impressive Olympic fashion and lands several yards away.",
